...
(Work In Progress, 4\~5 years away from version 0.1, 15\~20 years from stable version. However, it will be good enough to be used for research in a few month)

Husky is primarily a research language for computer science research in general. So it's born with ergonomics in mind. It's going to be easy to use and polished like any industrial language, and even better than that.
