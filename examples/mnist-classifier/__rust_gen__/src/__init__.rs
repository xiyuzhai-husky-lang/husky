...
pub static LINKAGES: &[(__StaticLinkageKey, __Linkage)] = &[
    ...
    (
        ...
        lazy_field_linkage!(connected_component::ConnectedComponent, __registration__::__CONNECTED_COMPONENT_VTABLE, i32, __registration__::__I32_VTABLE, max_row_span)
    ),
    (
