...
#[rustfmt::skip]
linket_impls![
    fn_linket_impl!(mnist_classifier::main),
    ...
    struct_field_linket_impl!(mnist_classifier::connected_component::ConnectedComponentDistribution, row_start),
    struct_field_linket_impl!(mnist_classifier::connected_component::ConnectedComponentDistribution, row_end),
    struct_field_linket_impl!(mnist_classifier::connected_component::ConnectedComponentDistribution, upper_mass),
    struct_field_linket_impl!(mnist_classifier::connected_component::ConnectedComponentDistribution, lower_mass),
    ...
    struct_field_linket_impl!(mnist_classifier::connected_component::EffHoles, matches),
    ...
    struct_field_linket_impl!(mnist_classifier::connected_component::ConnectedComponent, mask),
    ...
    fn_linket_impl!(mnist_classifier::connected_component::ConnectedComponent::raw_contours),
    fn_linket_impl!(mnist_classifier::connected_component::ConnectedComponent::eff_holes),
    fn_linket_impl!(mnist_classifier::connected_component::ConnectedComponent::max_hole_ilen),
    fn_linket_impl!(mnist_classifier::connected_component::ConnectedComponent::max_row_span),
    fn_linket_impl!(mnist_classifier::connected_component::ConnectedComponent::row_span_sum),
    fn_linket_impl!(mnist_classifier::connected_component::ConnectedComponent::distribution),
    fn_linket_impl!(mnist_classifier::connected_component::ConnectedComponent::upper_mass),
    fn_linket_impl!(mnist_classifier::connected_component::ConnectedComponent::lower_mass),
    ...
    struct_field_linket_impl!(mnist_classifier::raw_contour::RawContour, cc),
    struct_field_linket_impl!(mnist_classifier::raw_contour::RawContour, points),
    ...
    struct_field_linket_impl!(mnist_classifier::raw_contour::StreakCache, prev1),
    struct_field_linket_impl!(mnist_classifier::raw_contour::StreakCache, prev2),
    ...
    fn_linket_impl!(mnist_classifier::raw_contour::RawContour::line_segment_sketch),
    fn_linket_impl!(mnist_classifier::raw_contour::RawContour::bounding_box),
    fn_linket_impl!(mnist_classifier::raw_contour::RawContour::relative_bounding_box),
    fn_linket_impl!(mnist_classifier::raw_contour::RawContour::contour_len),
    ...
    struct_field_linket_impl!(mnist_classifier::geom2d::Point2d, x),
    struct_field_linket_impl!(mnist_classifier::geom2d::Point2d, y),
    ...
    struct_field_linket_impl!(mnist_classifier::geom2d::RelativePoint2d, x),
    struct_field_linket_impl!(mnist_classifier::geom2d::RelativePoint2d, y),
    ...
    struct_field_linket_impl!(mnist_classifier::geom2d::Vector2d, x),
    struct_field_linket_impl!(mnist_classifier::geom2d::Vector2d, y),
    ...
    struct_field_linket_impl!(mnist_classifier::geom2d::ClosedRange, min),
    struct_field_linket_impl!(mnist_classifier::geom2d::ClosedRange, max),
    ...
    struct_field_linket_impl!(mnist_classifier::geom2d::BoundingBox, xrange),
    struct_field_linket_impl!(mnist_classifier::geom2d::BoundingBox, yrange),
    ...
    struct_field_linket_impl!(mnist_classifier::geom2d::RelativeBoundingBox, xrange),
    struct_field_linket_impl!(mnist_classifier::geom2d::RelativeBoundingBox, yrange),
    ...
    struct_field_linket_impl!(mnist_classifier::line_segment_sketch::LineSegmentStroke, points),
    struct_field_linket_impl!(mnist_classifier::line_segment_sketch::LineSegmentStroke, start),
    struct_field_linket_impl!(mnist_classifier::line_segment_sketch::LineSegmentStroke, end),
    ...
    struct_field_linket_impl!(mnist_classifier::line_segment_sketch::LineSegmentSketch, contour),
    struct_field_linket_impl!(mnist_classifier::line_segment_sketch::LineSegmentSketch, strokes),
    ...
    fn_linket_impl!(mnist_classifier::line_segment_sketch::LineSegmentSketch::concave_components),
    fn_linket_impl!(mnist_classifier::line_segment_sketch::LineSegmentSketch::bounding_box),
    ...
    struct_field_linket_impl!(mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent, line_segment_sketch),
    struct_field_linket_impl!(mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent, strokes),
    fn_linket_impl!(mnist_classifier::line_segment_sketch::concave_component::find_concave_components),
    fn_linket_impl!(mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent::norm),
    fn_linket_impl!(mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent::rel_norm),
    fn_linket_impl!(mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent::hausdorff_norm),
    fn_linket_impl!(mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent::angle_change),
    fn_linket_impl!(mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent::bounding_box),
    fn_linket_impl!(mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent::relative_bounding_box),
    ...
    struct_field_linket_impl!(mnist_classifier::line_segment_sketch::convex_component::ConvexComponent, line_segment_sketch),
    struct_field_linket_impl!(mnist_classifier::line_segment_sketch::convex_component::ConvexComponent, line_segments),
    ...
    struct_field_linket_impl!(mnist_classifier::line_segment_sketch::line_segment::LineSegment, start),
    struct_field_linket_impl!(mnist_classifier::line_segment_sketch::line_segment::LineSegment, end),
    ...
    struct_field_linket_impl!(mnist_classifier::fermi::FermiMatchResult, matches),
    struct_field_linket_impl!(mnist_classifier::fermi::FermiMatchResult, others),
    fn_linket_impl!(mnist_classifier::fermi::fermi_match),
    fn_linket_impl!(mnist_classifier::fermi::FermiMatchResult::norm),
    fn_linket_impl!(mnist_classifier::fermi::FermiMatchResult::rel_norm),
    fn_linket_impl!(mnist_classifier::fermi::FermiMatchResult::angle_change_norm),
    fn_linket_impl!(mnist_classifier::digits::zero::open_one_match),
    fn_linket_impl!(mnist_classifier::digits::zero::almost_closed),
    fn_linket_impl!(mnist_classifier::digits::zero::is_zero),
    fn_linket_impl!(mnist_classifier::digits::one::one_fermi_match),
    fn_linket_impl!(mnist_classifier::digits::one::is_one),
    ...
    fn_linket_impl!(mnist_classifier::digits::six::six_match),
    fn_linket_impl!(mnist_classifier::digits::six::six_match_refined1),
    fn_linket_impl!(mnist_classifier::digits::six::is_six),
    fn_linket_impl!(mnist_classifier::digits::six::upmost),
    fn_linket_impl!(mnist_classifier::digits::six::bottom1),
    fn_linket_impl!(mnist_classifier::digits::three::three_fermi_match),
    fn_linket_impl!(mnist_classifier::digits::three::is_three),
    ...
    fn_linket_impl!(mnist_classifier::digits::four::left_components),
    fn_linket_impl!(mnist_classifier::digits::four::left_coordinate_max),
    fn_linket_impl!(mnist_classifier::digits::four::components_max_downwards),
    fn_linket_impl!(mnist_classifier::digits::four::components_max_heights),
    fn_linket_impl!(mnist_classifier::digits::four::is_four),
    ...
    fn_linket_impl!(mnist_classifier::digits::five::is_five),
    fn_linket_impl!(mnist_classifier::digits::seven::simple_seven_match),
    fn_linket_impl!(mnist_classifier::digits::seven::simple_leftdown_pattern),
    fn_linket_impl!(mnist_classifier::digits::seven::special_seven_match),
    ...
    fn_linket_impl!(mnist_classifier::digits::seven::is_seven),
    fn_linket_impl!(mnist_classifier::digits::eight::upper_mouth_match),
    fn_linket_impl!(mnist_classifier::digits::eight::is_eight),
    fn_linket_impl!(mnist_classifier::digits::eight::big_mouth),
    fn_linket_impl!(mnist_classifier::digits::nine::nine_match),
    fn_linket_impl!(mnist_classifier::digits::nine::nine_match_refine),
    fn_linket_impl!(mnist_classifier::digits::nine::is_nine),
    fn_linket_impl!(mnist_classifier::digits::nine::downmost),
    fn_linket_impl!(mnist_classifier::digits::nine::big_cc),
    fn_linket_impl!(mnist_classifier::digits::two::two_match),
    ...
    fn_linket_impl!(mnist_classifier::digits::two::is_two),
    fn_linket_impl!(mnist_classifier::major::connected_components),
    fn_linket_impl!(mnist_classifier::major::major_connected_component),
    fn_linket_impl!(mnist_classifier::major::ignored_connected_components_row_span_sum_sum),
    fn_linket_impl!(mnist_classifier::major::major_raw_contours),
    fn_linket_impl!(mnist_classifier::major::major_raw_contour),
    fn_linket_impl!(mnist_classifier::major::major_line_segment_sketch),
    fn_linket_impl!(mnist_classifier::major::major_concave_components),
    ...
    enum_variant_field_linket_impl!(Option<f32>, Option::Some, (v0)),
    ...
    enum_variant_field_linket_impl!(malamute::Class<mnist::MnistLabel>, malamute::Class::Known, (v0)),
    ...
    enum_variant_field_linket_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::Continue, (v0)),
    ...
    enum_variant_field_linket_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::Break, (v0)),
];