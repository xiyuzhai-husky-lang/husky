...
linkage_impls![
    ...
    <Vec<mnist_classifier::geom2d::Point2d>>::last,
    <Vec<mnist_classifier::geom2d::Point2d>>::last,
    ...
    <CyclicSlice<mnist_classifier::geom2d::Point2d>>::first,
    <todo!() as Clone>::clone,
    <CyclicSlice<mnist_classifier::geom2d::Point2d>>::last,
    <Vec<mnist_classifier::line_segment_sketch::LineSegmentStroke>>::ilen,
    <Vec<mnist_classifier::line_segment_sketch::LineSegmentStroke>>::last,
    <Vec<mnist_classifier::line_segment_sketch::LineSegmentStroke>>::last,
    <CyclicSlice<mnist_classifier::geom2d::Point2d>>::start,
    <Vec<mnist_classifier::line_segment_sketch::LineSegmentStroke>>::pop,
    <CyclicSlice<mnist_classifier::geom2d::Point2d>>::end,
    <Vec<mnist_classifier::line_segment_sketch::LineSegmentStroke>>::push,
    <Vec<mnist_classifier::line_segment_sketch::LineSegmentStroke>>::first,
    <Vec<mnist_classifier::line_segment_sketch::LineSegmentStroke>>::first,
    ...
    <CyclicSlice<mnist_classifier::line_segment_sketch::LineSegmentStroke>>::first,
    <CyclicSlice<mnist_classifier::line_segment_sketch::LineSegmentStroke>>::last,
