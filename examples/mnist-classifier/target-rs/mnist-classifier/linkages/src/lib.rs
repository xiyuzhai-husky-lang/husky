...
linkage_impls![
    ...
    destructor_fn_linkage_impl!(mnist_classifier::connected_component::ConnectedComponentDistribution::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::connected_component::ConnectedComponentDistribution::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::connected_component::ConnectedComponentDistribution::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::connected_component::EffHoles::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::connected_component::EffHoles::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::connected_component::EffHoles::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::connected_component::ConnectedComponent::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::connected_component::ConnectedComponent::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::connected_component::ConnectedComponent::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::RawContour::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::RawContour::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::RawContour::__destructor),
    ...
    fn_linkage_impl!(mnist_classifier::raw_contour::Direction::Up),
    fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Up_discriminator),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Up_destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Up_destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Up_destructor),
    fn_linkage_impl!(mnist_classifier::raw_contour::Direction::Left),
    fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Left_discriminator),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Left_destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Left_destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Left_destructor),
    fn_linkage_impl!(mnist_classifier::raw_contour::Direction::Down),
    fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Down_discriminator),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Down_destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Down_destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Down_destructor),
    fn_linkage_impl!(mnist_classifier::raw_contour::Direction::Right),
    fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Right_discriminator),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Right_destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Right_destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::Direction::__Right_destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::StreakCache::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::StreakCache::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::raw_contour::StreakCache::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::Point2d::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::Point2d::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::Point2d::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::RelativePoint2d::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::RelativePoint2d::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::RelativePoint2d::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::Vector2d::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::Vector2d::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::Vector2d::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::ClosedRange::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::ClosedRange::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::ClosedRange::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::BoundingBox::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::BoundingBox::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::BoundingBox::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::RelativeBoundingBox::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::RelativeBoundingBox::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::geom2d::RelativeBoundingBox::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::LineSegmentStroke::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::LineSegmentStroke::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::LineSegmentStroke::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::LineSegmentSketch::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::LineSegmentSketch::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::LineSegmentSketch::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::convex_component::ConvexComponent::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::convex_component::ConvexComponent::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::convex_component::ConvexComponent::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::line_segment::LineSegment::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::line_segment::LineSegment::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::line_segment_sketch::line_segment::LineSegment::__destructor),
    ...
    destructor_fn_linkage_impl!(mnist_classifier::fermi::FermiMatchResult::__destructor_ref),
    destructor_fn_linkage_impl!(mnist_classifier::fermi::FermiMatchResult::__destructor_mut),
    destructor_fn_linkage_impl!(mnist_classifier::fermi::FermiMatchResult::__destructor),
    ...
    fn_linkage_impl!(Option::__Some_discriminator::<f32>),
    destructor_fn_linkage_impl!(Option::__Some_destructor_ref::<f32>),
    destructor_fn_linkage_impl!(Option::__Some_destructor_mut::<f32>),
    destructor_fn_linkage_impl!(Option::__Some_destructor::<f32>),
    fn_linkage_impl!(Option::None::<f32>),
    fn_linkage_impl!(Option::__None_discriminator::<f32>),
    destructor_fn_linkage_impl!(Option::__None_destructor_ref::<f32>),
    destructor_fn_linkage_impl!(Option::__None_destructor_mut::<f32>),
    destructor_fn_linkage_impl!(Option::__None_destructor::<f32>),
    fn_linkage_impl!(malamute::Class::Known::<mnist::MnistLabel>),
    fn_linkage_impl!(malamute::Class::__Known_discriminator::<mnist::MnistLabel>),
    destructor_fn_linkage_impl!(malamute::Class::__Known_destructor_ref::<mnist::MnistLabel>),
    destructor_fn_linkage_impl!(malamute::Class::__Known_destructor_mut::<mnist::MnistLabel>),
    destructor_fn_linkage_impl!(malamute::Class::__Known_destructor::<mnist::MnistLabel>),
    fn_linkage_impl!(malamute::Class::Unknown::<mnist::MnistLabel>),
    fn_linkage_impl!(malamute::Class::__Unknown_discriminator::<mnist::MnistLabel>),
    destructor_fn_linkage_impl!(malamute::Class::__Unknown_destructor_ref::<mnist::MnistLabel>),
    destructor_fn_linkage_impl!(malamute::Class::__Unknown_destructor_mut::<mnist::MnistLabel>),
    destructor_fn_linkage_impl!(malamute::Class::__Unknown_destructor::<mnist::MnistLabel>),
    fn_linkage_impl!(husky_core::ops::ControlFlow::Continue::<malamute::Class<mnist::MnistLabel>, ()>),
    fn_linkage_impl!(husky_core::ops::ControlFlow::__Continue_discriminator::<malamute::Class<mnist::MnistLabel>, ()>),
    destructor_fn_linkage_impl!(husky_core::ops::ControlFlow::__Continue_destructor_ref::<malamute::Class<mnist::MnistLabel>, ()>),
    destructor_fn_linkage_impl!(husky_core::ops::ControlFlow::__Continue_destructor_mut::<malamute::Class<mnist::MnistLabel>, ()>),
    destructor_fn_linkage_impl!(husky_core::ops::ControlFlow::__Continue_destructor::<malamute::Class<mnist::MnistLabel>, ()>),
    fn_linkage_impl!(husky_core::ops::ControlFlow::Break::<malamute::Class<mnist::MnistLabel>, ()>),
    fn_linkage_impl!(husky_core::ops::ControlFlow::__Break_discriminator::<malamute::Class<mnist::MnistLabel>, ()>),
    destructor_fn_linkage_impl!(husky_core::ops::ControlFlow::__Break_destructor_ref::<malamute::Class<mnist::MnistLabel>, ()>),
    destructor_fn_linkage_impl!(husky_core::ops::ControlFlow::__Break_destructor_mut::<malamute::Class<mnist::MnistLabel>, ()>),
    destructor_fn_linkage_impl!(husky_core::ops::ControlFlow::__Break_destructor::<malamute::Class<mnist::MnistLabel>, ()>),
];