...
linkage_impls![
    ...
    struct_destructor_linkage_impl!(mnist_classifier::connected_component::ConnectedComponentDistribution, row_start, row_end, upper_mass, lower_mass),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::connected_component::EffHoles, matches),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::connected_component::ConnectedComponent, mask),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::raw_contour::RawContour, cc, points),
    ...
    enum_variant_unit_constructor_linkage_impl!(mnist_classifier::raw_contour::Direction::Up),
    enum_variant_discriminator_linkage_impl!(mnist_classifier::raw_contour::Direction, mnist_classifier::raw_contour::Direction::__Up_discriminator),
    enum_variant_unit_constructor_linkage_impl!(mnist_classifier::raw_contour::Direction::Left),
    enum_variant_discriminator_linkage_impl!(mnist_classifier::raw_contour::Direction, mnist_classifier::raw_contour::Direction::__Left_discriminator),
    enum_variant_unit_constructor_linkage_impl!(mnist_classifier::raw_contour::Direction::Down),
    enum_variant_discriminator_linkage_impl!(mnist_classifier::raw_contour::Direction, mnist_classifier::raw_contour::Direction::__Down_discriminator),
    enum_variant_unit_constructor_linkage_impl!(mnist_classifier::raw_contour::Direction::Right),
    enum_variant_discriminator_linkage_impl!(mnist_classifier::raw_contour::Direction, mnist_classifier::raw_contour::Direction::__Right_discriminator),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::raw_contour::StreakCache, prev1, prev2),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::geom2d::Point2d, x, y),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::geom2d::RelativePoint2d, x, y),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::geom2d::Vector2d, x, y),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::geom2d::ClosedRange, min, max),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::geom2d::BoundingBox, xrange, yrange),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::geom2d::RelativeBoundingBox, xrange, yrange),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::line_segment_sketch::LineSegmentStroke, points, start, end),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::line_segment_sketch::LineSegmentSketch, contour, strokes),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent, line_segment_sketch, strokes),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::line_segment_sketch::convex_component::ConvexComponent, line_segment_sketch, line_segments),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::line_segment_sketch::line_segment::LineSegment, start, end),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::fermi::FermiMatchResult, matches, others),
    ...
    enum_variant_tuple_constructor_linkage_impl!(Option::Some),
    enum_variant_discriminator_linkage_impl!(Option<f32>, Option::__Some_discriminator),
    enum_variant_destructor_linkage_impl!(Option<f32>, Option::__Some_destructor, v0),
    enum_variant_field_linkage_impl!(Option<f32>, Option::Some, .0),
    enum_variant_unit_constructor_linkage_impl!(Option::None),
    enum_variant_discriminator_linkage_impl!(Option<f32>, Option::__None_discriminator),
    enum_variant_tuple_constructor_linkage_impl!(malamute::Class::Known),
    enum_variant_discriminator_linkage_impl!(malamute::Class<mnist::MnistLabel>, malamute::Class::__Known_discriminator),
    enum_variant_destructor_linkage_impl!(malamute::Class<mnist::MnistLabel>, malamute::Class::__Known_destructor, v0),
    enum_variant_field_linkage_impl!(malamute::Class<mnist::MnistLabel>, malamute::Class::Known, .0),
    enum_variant_unit_constructor_linkage_impl!(malamute::Class::Unknown),
    enum_variant_discriminator_linkage_impl!(malamute::Class<mnist::MnistLabel>, malamute::Class::__Unknown_discriminator),
    enum_variant_tuple_constructor_linkage_impl!(husky_core::ops::ControlFlow::Continue),
    enum_variant_discriminator_linkage_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::__Continue_discriminator),
    enum_variant_destructor_linkage_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::__Continue_destructor, v0),
    enum_variant_field_linkage_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::Continue, .0),
    enum_variant_tuple_constructor_linkage_impl!(husky_core::ops::ControlFlow::Break),
    enum_variant_discriminator_linkage_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::__Break_discriminator),
    enum_variant_destructor_linkage_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::__Break_destructor, v0),
    enum_variant_field_linkage_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::Break, .0),
];