...
linkage_impls![
    ...
    destructor_linkage_impl!(mnist_classifier::connected_component::ConnectedComponentDistribution::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::connected_component::EffHoles::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::connected_component::ConnectedComponent::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::raw_contour::RawContour::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::raw_contour::StreakCache::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::geom2d::Point2d::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::geom2d::RelativePoint2d::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::geom2d::Vector2d::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::geom2d::ClosedRange::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::geom2d::BoundingBox::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::geom2d::RelativeBoundingBox::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::line_segment_sketch::LineSegmentStroke::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::line_segment_sketch::LineSegmentSketch::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::line_segment_sketch::convex_component::ConvexComponent::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::line_segment_sketch::line_segment::LineSegment::__destructor),
    ...
    destructor_linkage_impl!(mnist_classifier::fermi::FermiMatchResult::__destructor),
    ...
    destructor_linkage_impl!(Option::__Some_destructor::<f32>),
    ...
    destructor_linkage_impl!(malamute::Class::__Known_destructor::<mnist::MnistLabel>),
    ...
    destructor_linkage_impl!(husky_core::ops::ControlFlow::__Continue_destructor::<malamute::Class<mnist::MnistLabel>, ()>),
    ...
    destructor_linkage_impl!(husky_core::ops::ControlFlow::__Break_destructor::<malamute::Class<mnist::MnistLabel>, ()>),
