...
linkage_impls![
    ...
    struct_destructor_linkage_impl!(mnist_classifier::connected_component::ConnectedComponentDistribution, mnist_classifier::connected_component::ConnectedComponentDistribution, row_start, row_end, upper_mass, lower_mass),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::connected_component::EffHoles, mnist_classifier::connected_component::EffHoles, matches),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::connected_component::ConnectedComponent, mnist_classifier::connected_component::ConnectedComponent, mask),
    ...
    enum_variant_discriminator_linkage_impl!(mnist_classifier::raw_contour::Direction, mnist_classifier::raw_contour::Direction::Left),
    enum_variant_constructor_linkage_impl!(mnist_classifier::raw_contour::Direction, mnist_classifier::raw_contour::Direction::Down),
    enum_variant_discriminator_linkage_impl!(mnist_classifier::raw_contour::Direction, mnist_classifier::raw_contour::Direction::Down),
    enum_variant_constructor_linkage_impl!(mnist_classifier::raw_contour::Direction, mnist_classifier::raw_contour::Direction::Right),
    enum_variant_discriminator_linkage_impl!(mnist_classifier::raw_contour::Direction, mnist_classifier::raw_contour::Direction::Right),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::raw_contour::StreakCache, mnist_classifier::raw_contour::StreakCache, prev1, prev2),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::geom2d::Point2d, mnist_classifier::geom2d::Point2d, x, y),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::geom2d::RelativePoint2d, mnist_classifier::geom2d::RelativePoint2d, x, y),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::geom2d::Vector2d, mnist_classifier::geom2d::Vector2d, x, y),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::geom2d::ClosedRange, mnist_classifier::geom2d::ClosedRange, min, max),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::geom2d::BoundingBox, mnist_classifier::geom2d::BoundingBox, xrange, yrange),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::geom2d::RelativeBoundingBox, mnist_classifier::geom2d::RelativeBoundingBox, xrange, yrange),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::line_segment_sketch::LineSegmentStroke, mnist_classifier::line_segment_sketch::LineSegmentStroke, points, start, end),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::line_segment_sketch::LineSegmentSketch, mnist_classifier::line_segment_sketch::LineSegmentSketch, contour, strokes),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent, mnist_classifier::line_segment_sketch::concave_component::ConcaveComponent, line_segment_sketch, strokes),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::line_segment_sketch::convex_component::ConvexComponent, mnist_classifier::line_segment_sketch::convex_component::ConvexComponent, line_segment_sketch, line_segments),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::line_segment_sketch::line_segment::LineSegment, mnist_classifier::line_segment_sketch::line_segment::LineSegment, start, end),
    ...
    struct_destructor_linkage_impl!(mnist_classifier::fermi::FermiMatchResult, mnist_classifier::fermi::FermiMatchResult, matches, others),
    ...
    enum_variant_discriminator_linkage_impl!(Option<f32>, Option::Some, ()),
    enum_variant_destructor_linkage_impl!(Option<f32>, Option::Some, (v0)),
    enum_variant_field_linkage_impl!(Option<f32>, Option::Some, (v0)),
    enum_variant_constructor_linkage_impl!(Option<f32>, Option::None),
    enum_variant_discriminator_linkage_impl!(Option<f32>, Option::None),
    enum_variant_constructor_linkage_impl!(malamute::Class<mnist::MnistLabel>, malamute::Class::Known, (v0)),
    enum_variant_discriminator_linkage_impl!(malamute::Class<mnist::MnistLabel>, malamute::Class::Known, ()),
    enum_variant_destructor_linkage_impl!(malamute::Class<mnist::MnistLabel>, malamute::Class::Known, (v0)),
    enum_variant_field_linkage_impl!(malamute::Class<mnist::MnistLabel>, malamute::Class::Known, (v0)),
    enum_variant_constructor_linkage_impl!(malamute::Class<mnist::MnistLabel>, malamute::Class::Unknown),
    enum_variant_discriminator_linkage_impl!(malamute::Class<mnist::MnistLabel>, malamute::Class::Unknown),
    enum_variant_constructor_linkage_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::Continue, (v0)),
    enum_variant_discriminator_linkage_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::Continue, ()),
    enum_variant_destructor_linkage_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::Continue, (v0)),
    enum_variant_field_linkage_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::Continue, (v0)),
    enum_variant_constructor_linkage_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::Break, (v0)),
    enum_variant_discriminator_linkage_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::Break, ()),
    enum_variant_destructor_linkage_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::Break, (v0)),
    enum_variant_field_linkage_impl!(husky_core::ops::ControlFlow<malamute::Class<mnist::MnistLabel>, ()>, husky_core::ops::ControlFlow::Break, (v0)),
];