...
impl crate::line_segment_sketch::concave_component::ConcaveComponent {
    #[ad_hoc_task_dependency::memo_field(ingredient_index = 15)]
    pub fn norm(&'static self) -> f32 {
        self.hausdorff_norm()
    }

    #[ad_hoc_task_dependency::memo_field(ingredient_index = 16)]
    pub fn rel_norm(&'static self) -> f32 {
        self.norm() / self.displacement().norm()
    }

    #[ad_hoc_task_dependency::memo_field(ingredient_index = 17)]
    ...
    #[ad_hoc_task_dependency::memo_field(ingredient_index = 18)]
    ...
    #[ad_hoc_task_dependency::memo_field(ingredient_index = 19, return_ref)]
    ...
    #[ad_hoc_task_dependency::memo_field(ingredient_index = 20, return_ref)]
