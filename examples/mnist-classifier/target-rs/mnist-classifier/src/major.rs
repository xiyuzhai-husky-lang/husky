...
#[rustfmt::skip]
#[ad_hoc_devsoul_dependency::val(item_path_id_interface = __connected_components__ITEM_PATH_ID_INTERFACE, return_leash)]
...
#[rustfmt::skip]
#[ad_hoc_devsoul_dependency::val(item_path_id_interface = __major_connected_component__ITEM_PATH_ID_INTERFACE)]
...
#[rustfmt::skip]
#[ad_hoc_devsoul_dependency::val(item_path_id_interface = __ignored_connected_components_row_span_sum_sum__ITEM_PATH_ID_INTERFACE)]
...
#[rustfmt::skip]
#[ad_hoc_devsoul_dependency::val(item_path_id_interface = __major_raw_contours__ITEM_PATH_ID_INTERFACE)]
...
#[rustfmt::skip]
#[ad_hoc_devsoul_dependency::val(item_path_id_interface = __major_raw_contour__ITEM_PATH_ID_INTERFACE)]
...
#[rustfmt::skip]
#[ad_hoc_devsoul_dependency::val(item_path_id_interface = __major_line_segment_sketch__ITEM_PATH_ID_INTERFACE)]
...
#[rustfmt::skip]
#[ad_hoc_devsoul_dependency::val(item_path_id_interface = __major_concave_components__ITEM_PATH_ID_INTERFACE)]
