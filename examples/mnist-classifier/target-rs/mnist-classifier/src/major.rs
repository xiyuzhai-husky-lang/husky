...
pub fn major_raw_contours() -> Leash<Vec<crate::raw_contour::RawContour>> {
    &Leash(&<crate::connected_component::ConnectedComponent>::raw_contours(major_connected_component()))
}
...
pub fn major_line_segment_sketch() -> Leash<crate::line_segment_sketch::LineSegmentSketch> {
    &Leash(&<crate::raw_contour::RawContour>::line_segment_sketch(major_raw_contour()))
}
...
pub fn major_concave_components() -> Leash<Vec<crate::line_segment_sketch::concave_component::ConcaveComponent>> {
    &Leash(&<crate::line_segment_sketch::LineSegmentSketch>::concave_components(major_line_segment_sketch()))
}