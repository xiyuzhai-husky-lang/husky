...
pub fn is_two() -> malamute::OneVsAll {
    ...
    if cc_num == 2 {
        ...
        let right_ymax = <crate::line_segment_sketch::concave_component::ConcaveComponent>::relative_bounding_box(right_cc.unwrap()).ymax();
        let right_ymin = <crate::line_segment_sketch::concave_component::ConcaveComponent>::relative_bounding_box(right_cc.unwrap()).ymin();
    ...
    if cc_num == 3 {
        ...
        require!(<crate::line_segment_sketch::concave_component::ConcaveComponent>::relative_bounding_box(down_cc.unwrap()).ymin() < 0.4f32);
