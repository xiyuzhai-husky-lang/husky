...
linkage_impls![
    ...
    enum_variant_constructor_linkage_impl!(malamute::OneVsAll::Yes),
    enum_variant_discriminator_linkage_impl!(malamute::OneVsAll, malamute::OneVsAll::Yes),
    enum_variant_constructor_linkage_impl!(malamute::OneVsAll::No),
    ...
    enum_variant_constructor_linkage_impl!(malamute::OneVsAllResult::ConfidentYes),
    enum_variant_discriminator_linkage_impl!(malamute::OneVsAllResult, malamute::OneVsAllResult::ConfidentYes),
    enum_variant_constructor_linkage_impl!(malamute::OneVsAllResult::ConfidentNo),
    enum_variant_discriminator_linkage_impl!(malamute::OneVsAllResult, malamute::OneVsAllResult::ConfidentNo),
    enum_variant_constructor_linkage_impl!(malamute::OneVsAllResult::Unconfident),
    ...
    enum_variant_constructor_linkage_impl!(husky_core::ops::ControlFlow::Continue, (v0)),
    ...
    enum_variant_constructor_linkage_impl!(husky_core::ops::ControlFlow::Break, (v0)),
