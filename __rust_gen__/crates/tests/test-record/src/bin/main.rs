...
use husky_debugger::*;
use test_record::__init__::LINKAGES;

#[tokio::main]
async fn main() {
    let code_snapshot_dir = "crates/tests/test-record/snapshot/test-record".into();
    HuskyDebugger::new(
        HuskyDebuggerConfig {
...
fn serve_on_error() {
    ...
    let code_snapshot_dir = "snapshot/test-record".into();
