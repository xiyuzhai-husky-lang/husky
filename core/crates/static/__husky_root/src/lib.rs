...
pub mod __init_utils {
    ...
    pub use vm::{
        ...
        __SpecificRoutineLinkage, __TempValue, field_copy_fp, field_eval_ref_fp, field_linkage,
        ...
        index_temp_ref_fp, method_elem_copy_fp, method_elem_eval_ref_fp, method_elem_linkage,
        method_elem_move_fp, method_elem_temp_mut_fp, method_elem_temp_ref_fp, mut_field_linkage,
