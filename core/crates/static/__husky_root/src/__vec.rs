...
pub static VEC_LEN: EntityStaticDefn = EntityStaticDefn {
    ...
    variant: EntityStaticDefnVariant::Method {
        ...
        opt_linkage: Some(specific_transfer_linkage!(generic_vec_len)),
        output_liason: OutputLiason::Transfer,
    },
    dev_src: __static_dev_src!(),
};
...
pub static VEC_PUSH: EntityStaticDefn = EntityStaticDefn {
    ...
    variant: EntityStaticDefnVariant::Method {
        ...
        spatial_parameters: &[],
        method_static_defn_kind: MethodStaticDefnKind::TypeMethod,
        opt_linkage: Some(specific_transfer_linkage!(generic_vec_push)),
        output_liason: OutputLiason::Transfer,
    },
    dev_src: __static_dev_src!(),
};
...
pub static VEC_POPX: EntityStaticDefn = EntityStaticDefn {
    ...
    variant: EntityStaticDefnVariant::Method {
        ...
        spatial_parameters: &[],
        method_static_defn_kind: MethodStaticDefnKind::TypeMethod,
        opt_linkage: Some(specific_transfer_linkage!(generic_vec_pop)),
        output_liason: OutputLiason::Transfer,
    },
    dev_src: __static_dev_src!(),
};
