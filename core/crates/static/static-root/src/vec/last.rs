    ...
    variant: EntityStaticDefnVariant::Method {
        ...
        kind: MethodStaticDefnVariant::TypeMethod {
            source: LinkageSource::MemberAccess {
                copy_access: linkage!(generic_vec_last_copy, 1),
                eval_ref_access: linkage!(generic_vec_last_eval_ref, 1),
                temp_ref_access: linkage!(generic_vec_last_temp_ref, 1),
                temp_mut_access: linkage!(generic_vec_last_mut, 1),
                move_access: linkage!(generic_vec_last_move, 1),
            },
        },
