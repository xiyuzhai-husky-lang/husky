...
pub static F32_MIN: EntityStaticDefn = EntityStaticDefn {
    ...
    variant: EntityStaticDefnVariant::Method {
        ...
        opt_linkage: Some(transfer_linkage!(|_, values| {
            let this = values[0].primitive().take_f32();
            let other = values[0].primitive().take_f32();
...
pub static F32_SGN: EntityStaticDefn = EntityStaticDefn {
    ...
    variant: EntityStaticDefnVariant::Method {
        ...
        method_static_defn_kind: MethodStaticDefnKind::TypeMethod,
        opt_linkage: Some(transfer_linkage!(|_, values| {
            let f = values[0].primitive().take_f32();
             f.sgnx() .to_register() 
        }, some f32::sgnx)),
    },
    dev_src: __static_dev_src!(),
...
pub static F32_ABS: EntityStaticDefn = EntityStaticDefn {
    ...
    variant: EntityStaticDefnVariant::Method {
        ...
        method_static_defn_kind: MethodStaticDefnKind::TypeMethod,
        opt_linkage: Some(transfer_linkage!(|_, values| {
             values[0].primitive().take_f32().abs() .to_register() 
        }, some f32::abs)),
    },
    dev_src: __static_dev_src!(),
};
...
pub static F32_SQRT: EntityStaticDefn = EntityStaticDefn {
    ...
    variant: EntityStaticDefnVariant::Method {
        ...
        method_static_defn_kind: MethodStaticDefnKind::TypeMethod,
        opt_linkage: Some(transfer_linkage!(|_, values| {
             values[0].primitive().take_f32().sqrt().to_register()
        }, some f32::sqrt)),
    },
    dev_src: __static_dev_src!(),
};
...
pub static F32_COS: EntityStaticDefn = EntityStaticDefn {
    ...
    variant: EntityStaticDefnVariant::Method {
        ...
        method_static_defn_kind: MethodStaticDefnKind::TypeMethod,
        opt_linkage: Some(transfer_linkage!(|_, values| {
            values[0].primitive().take_f32().cos().to_register()
        }, some f32::cos)),
    },
    dev_src: __static_dev_src!(),
};
...
pub static F32_SIN: EntityStaticDefn = EntityStaticDefn {
    ...
    variant: EntityStaticDefnVariant::Method {
        ...
        method_static_defn_kind: MethodStaticDefnKind::TypeMethod,
        opt_linkage: Some(transfer_linkage!(|_, values| {
             values[0].primitive().take_f32().sin() .to_register() 
        }, some f32::sin)),
    },
    dev_src: __static_dev_src!(),
};
...
pub static F32_TAN: EntityStaticDefn = EntityStaticDefn {
    ...
    variant: EntityStaticDefnVariant::Method {
        ...
        method_static_defn_kind: MethodStaticDefnKind::TypeMethod,
        opt_linkage: Some(transfer_linkage!(|_, values| {
             values[0].primitive().take_f32().tan() .to_register() 
        }, some f32::tan)),
    },
    dev_src: __static_dev_src!(),
};
...
pub static F32_ACOS: EntityStaticDefn = EntityStaticDefn {
    ...
    variant: EntityStaticDefnVariant::Method {
        ...
        method_static_defn_kind: MethodStaticDefnKind::TypeMethod,
        opt_linkage: Some(transfer_linkage!(|_, values| {
             values[0].primitive().take_f32().acos() .to_register() 
        }, some f32::acos)),
    },
    dev_src: __static_dev_src!(),
};
...
pub static F32_ASIN: EntityStaticDefn = EntityStaticDefn {
    ...
    variant: EntityStaticDefnVariant::Method {
        ...
        method_static_defn_kind: MethodStaticDefnKind::TypeMethod,
        opt_linkage: Some(transfer_linkage!(|_, values| {
             values[0].primitive().take_f32().asin() .to_register() 
        }, some f32::asin)),
    },
    dev_src: __static_dev_src!(),
};
...
pub static F32_ATAN: EntityStaticDefn = EntityStaticDefn {
    ...
    variant: EntityStaticDefnVariant::Method {
        ...
        method_static_defn_kind: MethodStaticDefnKind::TypeMethod,
        opt_linkage: Some(transfer_linkage!(|_, values| {
             values[0].primitive().take_f32().atan() .to_register() 
        }, some f32::atan)),
    },
    dev_src: __static_dev_src!(),
};
