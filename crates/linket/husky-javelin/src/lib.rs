...
//! a javelin is a group of linkets, the name inspired by Diablo 2. For instance, the type constructor javelin will contains the type constructor linket and also the (pattern) field access linkets.
//!
//! It's easier to collect javelins. We first collect javelins and then flatten them to get linkets.
//!
