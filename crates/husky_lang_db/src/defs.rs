...
use crate::{helpers::try_resolve_derive_input, HuskyLangDatabase};
...
impl Definition {
    ...
    pub fn module(&self, db: &HuskyLangDatabase) -> Option<Module> {
        todo!()
    }

    pub fn visibility(&self, db: &HuskyLangDatabase) -> Option<Visibility> {
        todo!()
    }

    pub fn name(&self, db: &HuskyLangDatabase) -> Option<Name> {
        todo!()
    }
}
...
impl NameClass {
    ...
    pub fn classify(sema: &Semantics<HuskyLangDatabase>, name: &ast::Name) -> Option<NameClass> {
        todo!()
    }
}
