...
impl ImportAssets {
    ...
    pub fn for_ident_pat(sema: &Semantics<HuskyLangDatabase>, pat: &ast::IdentPat) -> Option<Self> {
        todo!()
    }

    pub fn for_derive_ident(
        sema: &Semantics<HuskyLangDatabase>,
        ident: &ast::Ident,
    ) -> Option<Self> {
        todo!()
...
impl ImportAssets {
    ...
    fn scope_definitions(&self, sema: &Semantics<HuskyLangDatabase>) -> FxHashSet<ScopeDef> {
        todo!()
    }
}
...
pub fn item_for_path_search(db: &HuskyLangDatabase, item: ItemInNs) -> Option<ItemInNs> {
    todo!()
}
...
impl ImportCandidate {
    ...
    fn for_regular_path(sema: &Semantics<HuskyLangDatabase>, path: &ast::Path) -> Option<Self> {
        todo!()
    }

    fn for_name(sema: &Semantics<HuskyLangDatabase>, name: &ast::Name) -> Option<Self> {
        todo!()
    }
...
fn item_as_assoc(db: &HuskyLangDatabase, item: ItemInNs) -> Option<AssocItem> {
    todo!()
}
