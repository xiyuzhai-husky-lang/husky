...
impl<'tree, Tab> DockArea<'tree, Tab> {
    ...
    fn tab_title(
        ...
        let title_stroke_width = 0.0;
        // let title_stroke_width = 1.0;
        let stroke_rect = rect_stroke_box(rect, title_stroke_width);
        ui.painter().rect_stroke(
            stroke_rect,
            tab_style.rounding,
            Stroke::new(title_stroke_width, tab_style.outline_color),
        );
        if !is_being_dragged {
