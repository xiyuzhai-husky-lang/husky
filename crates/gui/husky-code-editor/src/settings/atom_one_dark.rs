...
pub fn atom_one_theme_map(token_class: TokenClass) -> Color32 {
    match token_class {
        ...
        TokenClass::Variable => ATOM_ONE_DARK_COLOR_BRIGHT_BLUE,
        TokenClass::LoopVariable => ATOM_ONE_DARK_COLOR_WHITE,
        TokenClass::ModuleEntity => ATOM_ONE_DARK_COLOR_WHITE,
        TokenClass::TypeEntity => ATOM_ONE_DARK_COLOR_BRIGHT_YELLOW,
        TokenClass::TypeAlias => ATOM_ONE_DARK_COLOR_BRIGHT_YELLOW,
        TokenClass::TypeVar => ATOM_ONE_DARK_COLOR_BRIGHT_YELLOW,
        ...
        TokenClass::DefEntity => ATOM_ONE_DARK_COLOR_BRIGHT_PURPLE,
        TokenClass::StaticMutEntity => ATOM_ONE_DARK_COLOR_BRIGHT_PURPLE,
        TokenClass::StaticVarEntity => ATOM_ONE_DARK_COLOR_BRIGHT_PURPLE,
        TokenClass::TermicEntity => ATOM_ONE_DARK_COLOR_BRIGHT_CYAN,
