...
pub struct TraceJar(
    ...
    ValItemTracePath,
    ValItemTrace,
    val_item_trace_view_lines,
    val_item_trace_subtraces,
    LazyCallTracePath,
    LazyCallTrace,
    LazyExprTracePath,
    LazyExprTrace,
    lazy_expr_trace_view_lines,
    LazyStmtTracePath,
    LazyStmtTrace,
    lazy_stmt_trace_view_lines,
    lazy_stmt_trace_subtraces,
    // lazy_stmt_associated_expr_traces,
    EagerCallTracePath,
    EagerCallTrace,
    EagerExprTracePath,
    EagerExprTrace,
    eager_expr_trace_view_lines,
    eager_expr_trace_have_subtraces,
    eager_expr_trace_subtraces,
    EagerStmtTracePath,
    EagerStmtTrace,
    eager_stmt_trace_subtraces,
    eager_stmt_trace_view_lines,
    LoopGroupTracePath,
    LoopGroupTrace,
    // helpers
