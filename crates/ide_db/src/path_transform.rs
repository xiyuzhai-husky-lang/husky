...
use semantics::{HirDisplay, SemanticsScope};
...
pub struct PathTransform<'a> {
    generic_def: semantics::GenericDef,
    substs: Vec<ast::Type>,
...
impl<'a> PathTransform<'a> {
    ...
    fn build_ctx(&self) -> Option<Ctx<'a>> {
        ...
        let skip = match self.generic_def {
            ...
            semantics::GenericDef::Trait(_) => 1,
            _ => 0,
        };
...
struct Ctx<'a> {
    substs: FxHashMap<semantics::TypeParam, ast::Type>,
    target_module: semantics::Module,
    source_scope: &'a SemanticsScope<'a>,
}
...
impl<'a> Ctx<'a> {
    ...
    fn transform_path(&self, path: ast::Path) -> Option<()> {
        ...
        match resolution {
            ...
            semantics::PathResolution::Local(_)
            | semantics::PathResolution::ConstParam(_)
            | semantics::PathResolution::SelfType(_)
