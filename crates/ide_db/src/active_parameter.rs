...
/// Returns a [`semantics::Callable`] this token is a part of and its argument index of said callable.
pub fn callable_for_token(
    sema: &Semantics<RootDatabase>,
    token: SyntaxToken,
) -> Option<(semantics::Callable, Option<usize>)> {
