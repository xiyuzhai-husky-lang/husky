...
use semantics::db::{AstDatabase, DefDatabase, HirDatabase};
...
#[salsa::database(
    ...
    semantics::db::InternDatabaseStorage,
    semantics::db::AstDatabaseStorage,
    semantics::db::DefDatabaseStorage,
    semantics::db::HirDatabaseStorage
)]
...
impl RootDatabase {
    ...
    pub fn update_lru_capacity(&mut self, lru_capacity: Option<usize>) {
        ...
        semantics::db::ParseMacroExpansionQuery.in_db_mut(self).set_lru_capacity(lru_capacity);
        semantics::db::MacroExpandQuery.in_db_mut(self).set_lru_capacity(lru_capacity);
    }
}
