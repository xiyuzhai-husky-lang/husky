```rust
EntityTreeSheet {
    module_path: ModulePath(`mnist_classifier::line_segment_sketch::concave_component`),
    ...
    use_all_rules: UseAllRules(
        [
            ...
            UseAllRule {
                parent_module_path: ModulePath(`mnist_classifier::line_segment_sketch::convexity`),
                is_same_crate: true,
                ast_idx: 71,
                use_expr_idx: 7,
                visibility: Scope::PubUnder(
