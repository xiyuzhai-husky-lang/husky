```rust
EntityTreeSheet {
    module_path: ModulePath(`mnist_classifier::line_segment_sketch`),
    ...
    use_all_rules: UseAllRules(
        [
            UseAllRule {
                parent_module_path: ModulePath(`mnist_classifier::line_segment_sketch::concave_component`),
                is_same_crate: true,
                ast_idx: 163,
                use_expr_idx: 0,
                visibility: Scope::Pub,
            ...
            UseAllRule {
                parent_module_path: ModulePath(`mnist_classifier::line_segment_sketch::convex_component`),
                is_same_crate: true,
                ast_idx: 164,
                use_expr_idx: 2,
                visibility: Scope::Pub,
            ...
            UseAllRule {
                parent_module_path: ModulePath(`mnist_classifier::line_segment_sketch::line_segment`),
                is_same_crate: true,
                ast_idx: 165,
                use_expr_idx: 4,
                visibility: Scope::Pub,
