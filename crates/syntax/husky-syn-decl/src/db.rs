...
pub struct SynDeclJar(
    ...
    TypeMethodFnSynDecl,
    TypeAssocTypeSynNodeDecl,
    TypeAssocTypeSynDecl,
    TypeAssocValSynNodeDecl,
    TypeAssocValSynDecl,
    ...
    TraitForTypeAssocValSynNodeDecl,
    TraitForTypeAssocValSynDecl,
    // -- ill formed item
