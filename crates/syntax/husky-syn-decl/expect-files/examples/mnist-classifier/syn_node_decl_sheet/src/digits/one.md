        ...
        (
            ...
            ItemSynNodeDecl::MajorItem(
                MajorItemSynNodeDecl::Form(
                    FormSynNodeDecl::Val(
                        MajorValSynNodeDecl {
                            syn_node_path: MajorFormSynNodePath(`mnist_classifier::digits::one::one_fermi_match`, `Val`, (0)),
                            colon_token: Ok(
                                ColonRegionalToken(
                                    RegionalTokenIdx(
                                        3,
        ...
        (
            ...
            ItemSynNodeDecl::MajorItem(
                MajorItemSynNodeDecl::Form(
                    FormSynNodeDecl::Val(
                        MajorValSynNodeDecl {
                            syn_node_path: MajorFormSynNodePath(`mnist_classifier::digits::one::is_one`, `Val`, (0)),
                            colon_token: Ok(
                                ColonRegionalToken(
                                    RegionalTokenIdx(
                                        4,
                ...
                MajorItemSynNodeDecl::Form(
                    FormSynNodeDecl::FunctionRitchie(
                        MajorFunctionRitchieSynNodeDecl {
                            syn_node_path: MajorFormSynNodePath(`mnist_classifier::digits::one::upmost`, `Ritchie(
                                Fn,
                            )`, (0)),
        ...
        (
            ...
            ItemSynNodeDecl::MajorItem(
                MajorItemSynNodeDecl::Form(
                    FormSynNodeDecl::FunctionRitchie(
                        MajorFunctionRitchieSynNodeDecl {
                            syn_node_path: MajorFormSynNodePath(`mnist_classifier::digits::one::downmost`, `Ritchie(
                                Fn,
                            )`, (0)),
                            ritchie_item_kind: RitchieItemKind::Fn,
                            template_parameter_obelisk_list: Ok(
        ...
        (
            ...
            ItemSynNodeDecl::MajorItem(
                MajorItemSynNodeDecl::Form(
                    FormSynNodeDecl::FunctionRitchie(
                        MajorFunctionRitchieSynNodeDecl {
                            syn_node_path: MajorFormSynNodePath(`mnist_classifier::digits::one::hat`, `Ritchie(
                                Fn,
                            )`, (0)),
                            ritchie_item_kind: RitchieItemKind::Fn,
                            template_parameter_obelisk_list: Ok(
