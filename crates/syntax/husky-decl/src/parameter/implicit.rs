...
impl<'a, 'b> ParseFromStreamWithError<ExprParseContext<'a, 'b>> for ImplicitParameterDecl {
...
impl<'a, 'b> ParseFromStreamWithError<ExprParseContext<'a, 'b>> for ImplicitParameterDeclList {
    type Error = DeclExprError;
