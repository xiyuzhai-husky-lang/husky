...
/// struct MyDatabase {
///     runtime: salsa::SalsaRuntime<MyDatabase>, // <-- your database will need this field, too
/// }
/// ```
///
...
/// [`salsa::SalsaRuntime`]) and to implement the `salsa::Database` trait.
///
/// See [the `hello_world` example][hw] for more details.
///
/// [`salsa::SalsaRuntime`]: struct.SalsaRuntime.html
