...
impl<'a> TryParseOptionFromStream<CharStream<'a>> for A {
    type Error = ();
    fn try_parse_option_from_stream_without_guaranteed_rollback<'b>(
...
impl<'a> TryParseOptionFromStream<CharStream<'a>> for B {
    type Error = ();
    fn try_parse_option_from_stream_without_guaranteed_rollback<'b>(
        ctx: &mut CharStream<'b>,
    ) -> Result<Option<Self>, ()> {
...
impl<'a> TryParseOptionFromStream<CharStream<'a>> for Comma {
    type Error = ();
    fn try_parse_option_from_stream_without_guaranteed_rollback<'b>(
        ctx: &mut CharStream<'b>,
    ) -> Result<Option<Self>, ()> {
