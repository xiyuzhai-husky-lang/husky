...
pub trait DebugWithDb {
    ...
    fn debug_fmt_with_db(&self, f: &mut fmt::Formatter<'_>, db: &Db) -> fmt::Result;
}
...
impl fmt::Debug for DebugWith<'_> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        DebugWithDb::debug_fmt_with_db(&*self.value, f, self.db)
    }
}

impl DebugWithDb for () {
    fn debug_fmt_with_db(&self, f: &mut fmt::Formatter<'_>, _db: &Db) -> fmt::Result {
        f.write_str("()")
    }
}
...
impl DebugWithDb for String {
    fn debug_fmt_with_db(&self, f: &mut std::fmt::Formatter<'_>, _db: &Db) -> std::fmt::Result {
...
impl DebugWithDb for Infallible {
    fn debug_fmt_with_db(&self, _f: &mut fmt::Formatter<'_>, _db: &Db) -> fmt::Result {
        unreachable!()
    }
}
