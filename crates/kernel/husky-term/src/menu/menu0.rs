...
impl TermMenu0 {
    pub fn new(db: &dyn TermDb, toolchain: Toolchain) -> Self {
        ...
        TermMenu0 {
            ...
            list_ty: Term::Entity(entity_path_menu.list_ty_path().into()),
            ...
            bool: Term::Entity(entity_path_menu.bool_ty_path().into()),
            trai_ty: Term::Entity(entity_path_menu.trai_ty_path().into()),
            lifetime_ty: Term::Entity(entity_path_menu.lifetime_ty_path().into()),
