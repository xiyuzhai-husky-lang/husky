...
impl EntityPathMenu2 {
    pub(crate) fn new(db: &dyn EntityPathDb, menu1: EntityPathMenu1) -> Self {
        Self {
            ...
            core_basic_unit: menu1.core_basic().child(db, "unit"),
            core_basic_bool: menu1.core_basic().child(db, "bool"),
            core_basic_trai: menu1.core_basic().child(db, "Trait"),
            core_basic_module: menu1.core_basic().child(db, "Module"),
            ...
            core_ops_add: menu1.core_ops().child(db, "Add"),
            core_ops_add_assign: menu1.core_ops().child(db, "AddAssign"),
            core_ops_bit_and: menu1.core_ops().child(db, "BitAnd"),
            core_ops_bit_and_assign: menu1.core_ops().child(db, "BitAndAssign"),
            core_ops_bit_or: menu1.core_ops().child(db, "BitOr"),
            core_ops_bit_or_assign: menu1.core_ops().child(db, "BitOrAssign"),
            core_ops_bit_xor: menu1.core_ops().child(db, "BitXor"),
            core_ops_bit_xor_assign: menu1.core_ops().child(db, "BitXorAssign"),
            core_ops_div: menu1.core_ops().child(db, "Div"),
            core_ops_div_assign: menu1.core_ops().child(db, "DivAssign"),
            core_ops_mul: menu1.core_ops().child(db, "Mul"),
            core_ops_mul_assign: menu1.core_ops().child(db, "MulAssign"),
            core_ops_neg: menu1.core_ops().child(db, "Neg"),
            core_ops_not: menu1.core_ops().child(db, "Not"),
            parent: menu1,
        }
    }
