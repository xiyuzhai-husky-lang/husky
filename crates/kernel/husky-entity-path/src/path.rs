...
impl EntityPath {
    ...
    pub fn item_kind(self, db: &dyn EntityPathDb) -> EntityKind {
        match self {
            ...
            EntityPath::ModuleItem(path) => path.item_kind(db),
...
impl ItemPath {
    pub fn ident(self, db: &dyn EntityPathDb) -> Ident {
        match self {
            ...
            ItemPath::ModuleItem(path) => path.ident(db),
    ...
    pub fn module_item_path(self) -> Option<ModuleItemPath> {
        match self {
            ItemPath::ModuleItem(module_item_path) => Some(module_item_path),
            _ => None,
        }
    }
    ...
    pub fn module_path(self, db: &dyn EntityPathDb) -> ModulePath {
        match self {
            ...
            ItemPath::ModuleItem(path) => path.module_path(db),
    ...
    pub fn item_kind(self, db: &dyn EntityPathDb) -> EntityKind {
        match self {
            ...
            ItemPath::ModuleItem(path) => path.item_kind(db),
    ...
    pub fn major(self) -> Option<MajorEntityPath> {
        match self {
            ...
            ItemPath::ModuleItem(path) => Some(path.into()),
    ...
    Db: EntityPathDb + ?Sized,
{
    fn display_with_db_fmt(
        ...
        match self {
            ...
            ItemPath::ModuleItem(path) => path.display_with_db_fmt(f, db, level),
...
impl PrincipalEntityPath {
    ...
    pub fn item_kind(self, db: &dyn EntityPathDb) -> EntityKind {
        match self {
            ...
            PrincipalEntityPath::ModuleItem(path) => path.item_kind(db),
