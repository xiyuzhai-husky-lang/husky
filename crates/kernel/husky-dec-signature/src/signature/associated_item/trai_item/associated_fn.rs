...
pub struct TraitAssocFnDecTemplate {
    #[return_ref]
...
impl TraitAssocFnDecTemplate {
    pub(super) fn from_decl(
        db: &::salsa::Db,
        decl: TraitAssocFnSynDecl,
    ) -> DecSignatureResult<TraitAssocFnDecTemplate> {
        ...
        Ok(TraitAssocFnDecTemplate::new(
            db,
            template_parameters,
            parenate_parameters,
            return_ty,
