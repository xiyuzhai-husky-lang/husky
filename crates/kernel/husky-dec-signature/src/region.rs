...
impl SynExprDecTermRegion {
    ...
    pub fn pattern_ty_infos(&self) -> &SynPatternMap<PatternDeclarativeTypeInfo> {
        &self.pattern_ty_infos
    }

    pub fn pattern_variable_ty_infos(&self) -> &SynPatternSymbolMap<DecPatternVariableTypeInfo> {
