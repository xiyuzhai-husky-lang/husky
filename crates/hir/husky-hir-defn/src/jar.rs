...
pub struct HirDefnJar(
    ...
    crate::defn::major_item::ty::tuple_struct::tuple_struct_hir_defn_deps,
    ...
    crate::defn::major_item::form::val::val_hir_defn_deps,
    crate::defn::major_item::form::val::val_hir_defn_version_stamp,
    crate::defn::major_item::form::compterm::MajorComptermHirDefn,
    crate::defn::major_item::form::compterm::major_const_hir_defn_deps,
    crate::defn::major_item::form::compterm::major_const_hir_defn_version_stamp,
    crate::defn::major_item::form::static_mut::MajorStaticMutHirDefn,
    crate::defn::major_item::form::static_mut::major_static_mut_hir_defn_deps,
    crate::defn::major_item::form::static_mut::major_static_mut_hir_defn_version_stamp,
    crate::defn::major_item::form::static_var::MajorStaticVarHirDefn,
    crate::defn::major_item::form::static_var::major_static_var_hir_defn_deps, crate::defn::major_item::form::static_var::major_static_var_hir_defn_version_stamp,
    crate::defn::major_item::form::function_ritchie::MajorFunctionRitchieHirDefn,
    crate::defn::major_item::form::function_ritchie::major_function_ritchie_hir_defn_deps,
    ...
    crate::defn::major_item::form::ty_alias::ty_alias_hir_defn_deps,
    ...
    crate::defn::major_item::trai::trai_hir_defn_deps,
    crate::defn::major_item::trai::trai_hir_defn_version_stamp,
    // - enum variant,
    crate::defn::ty_variant::enum_unit_ty_variant::EnumUnitVariantHirDefn,
    crate::defn::ty_variant::enum_unit_ty_variant::enum_unit_variant_hir_defn_deps,
    ...
    crate::defn::ty_variant::enum_tuple_ty_variant::enum_tuple_variant_hir_defn_deps,
    ...
    crate::defn::ty_variant::enum_props_ty_variant::enum_props_variant_hir_defn_deps,
    ...
    crate::defn::assoc_item::ty_item::assoc_ritchie::ty_assoc_ritchie_hir_defn_deps,
    ...
    crate::defn::assoc_item::ty_item::method_ritchie::ty_method_ritchie_hir_defn_deps,
    ...
    crate::defn::assoc_item::ty_item::assoc_ty::ty_assoc_ty_hir_defn_deps,
    ...
    crate::defn::assoc_item::trai_item::assoc_ritchie::trai_assoc_fn_hir_defn_deps,
    ...
    crate::defn::assoc_item::trai_item::method_ritchie::trai_method_ritchie_hir_defn_deps,
    ...
    crate::defn::assoc_item::trai_item::assoc_ty::trai_assoc_ty_hir_defn_deps,
    ...
    crate::defn::assoc_item::trai_item::assoc_val::trai_assoc_val_hir_defn_deps,
    ...
    crate::defn::assoc_item::trai_for_ty_item::assoc_ritchie::trai_for_ty_assoc_fn_hir_defn_deps,
    ...
    crate::defn::assoc_item::trai_for_ty_item::method_ritchie::trai_for_ty_method_ritchie_hir_defn_deps,
    ...
    crate::defn::assoc_item::trai_for_ty_item::assoc_ty::trai_for_ty_assoc_ty_hir_defn_deps,
