...
fn main() {
    ...
    config.insert_use.prefix_kind = semantics::PrefixKind::ByCrate;
...
fn main() {
    ...
    config.insert_use.prefix_kind = semantics::PrefixKind::BySelf;
    check_edit_with_config(
        config.clone(),
        "Item",
        fixture,
...
fn main() {
    ...
    config.insert_use.prefix_kind = semantics::PrefixKind::Plain;
    check_edit_with_config(
        config,
        "Item",
        fixture,
