...
use semantics::{Local, Name, ScopeDef, Semantics, SemanticsScope, Type, TypeInfo};
use ide_db::{
...
pub(crate) struct CompletionContext<'a> {
    ...
    pub(super) krate: Option<semantics::Crate>,
...
impl<'a> CompletionContext<'a> {
    ...
    where
        I: semantics::HasVisibility + semantics::HasAttrs + semantics::HasCrate + Copy,
    {
    ...
    pub(crate) fn is_item_hidden(&self, item: &semantics::ItemInNs) -> bool {
    ...
    fn is_visible_impl(
        &self,
        vis: &semantics::Visibility,
        attrs: &semantics::Attrs,
        defining_crate: semantics::Crate,
    ) -> bool {
    ...
    fn is_doc_hidden(&self, attrs: &semantics::Attrs, defining_crate: semantics::Crate) -> bool {
