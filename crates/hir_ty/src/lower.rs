...
impl<'a> TyLoweringContext<'a> {
    ...
    pub fn with_debruijn<T>(
        ...
        self.impl_trait_counter
            .set(new_ctx.impl_trait_counter.get());
        self.opaque_type_data
            .replace(new_ctx.opaque_type_data.into_inner());
...
impl<'a> TyLoweringContext<'a> {
            ...
            TypeRef::ImplTrait(bounds) => {
                match self.impl_trait_mode {
                    ...
                    ImplTraitLoweringMode::Param => {
                        ...
                        self.impl_trait_counter
                            .set(idx + count_impl_traits(type_ref) as u16);
    ...
    fn lower_ty_only_param(&self, type_ref: &TypeRef) -> Option<TypeParamId> {
        ...
        let resolution = match self
            .resolver
            .resolve_path_in_type_ns(self.db.upcast(), path.mod_path())
        {
            Some((it, None)) => it,
            _ => return None,
        };
    ...
    fn lower_trait_ref_from_path(
        ...
        let resolved = match self
            .resolver
            .resolve_path_in_type_ns_fully(self.db.upcast(), path.mod_path())?
        {
            ...
            | WherePredicate::TypeBound { target, bound } => {
                let self_ty = match target {
                    ...
                    WherePredicateTypeTarget::TypeParam(param_id) => {
                        ...
                        let param_id = hir_def::TypeParamId {
                            parent: generic_def,
                            local_id: *param_id,
                        };
    ...
    fn lower_impl_trait(
        ...
        ReturnTypeImplTrait {
            bounds: crate::make_only_type_binders(1, predicates),
        }
    }
}
...
pub(crate) fn field_types_query(
    ...
    for (field_id, field_data) in var_data.fields().iter() {
        res.insert(
            field_id,
            make_binders(&generics, ctx.lower_ty(&field_data.type_ref)),
        )
    }
    Arc::new(res)
}
...
fn fn_sig_for_fn(db: &dyn HirDatabase, def: FunctionId) -> PolyFnSig {
    ...
    make_binders(
        &generics,
        CallableSig::from_params_and_return(params, ret, data.is_varargs()),
    )
}
...
fn fn_sig_for_struct_constructor(db: &dyn HirDatabase, def: StructId) -> PolyFnSig {
    ...
    Binders::new(
        binders,
        CallableSig::from_params_and_return(params, ret, false),
    )
}
...
pub(crate) fn return_type_impl_traits(
    ...
    let return_type_impl_traits = ReturnTypeImplTraits {
        impl_traits: ctx_ret.opaque_type_data.into_inner(),
    };
