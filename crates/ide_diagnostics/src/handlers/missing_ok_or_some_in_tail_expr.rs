use semantics::{db::AstDatabase, TypeInfo};
...
pub(crate) fn missing_ok_or_some_in_tail_expr(
    ...
    d: &semantics::MissingOkOrSomeInTailExpr,
) -> Diagnostic {
    Diagnostic::new(
...
fn fixes(ctx: &DiagnosticsContext<'_>, d: &semantics::MissingOkOrSomeInTailExpr) -> Option<Vec<Assist>> {
