...
pub(crate) fn incorrect_case(ctx: &DiagnosticsContext<'_>, d: &semantics::IncorrectCase) -> Diagnostic {
    Diagnostic::new(
...
fn fixes(ctx: &DiagnosticsContext<'_>, d: &semantics::IncorrectCase) -> Option<Vec<Assist>> {
