...
/// You can also perform queries from the command line with the `tex query`
...
///
/// ```sh
/// $ tex query example.typ "<note>" --field value
/// ["This is a note"]
/// ```
///
...
///
/// ```sh
/// $ tex query example.typ "<note>" --field value --one
/// "This is a note"
/// ```
#[func]
pub fn query(
