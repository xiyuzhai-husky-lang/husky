...
///               --format blob \
///               --keys-for-bin target/debug/tex \
///               --out crates/tex-library/assets/icudata.postcard  \
///               --overwrite
/// ```
///
...
///               --out crates/tex-library/assets/cj_linebreak_data.postcard \
///               --overwrite
/// ```
///
/// The used icu_datagen should be patched by
/// https://github.com/peng1999/icu4x/commit/b9beb6cbf633d61fc3d7983e5baf7f4449fbfae5
static CJ_LINEBREAK_DATA: &[u8] = include_bytes!("../../../assets/cj_linebreak_data.postcard");
...
pub(super) fn breakpoints<'a>(p: &'a Preparation<'a>, mut f: impl FnMut(usize, Breakpoint)) {
    ...
    loop {
        ...
        'hyphenate: {
            ...
            let Some(lang) = lang_at(p, last) else {
                break 'hyphenate;
            };
