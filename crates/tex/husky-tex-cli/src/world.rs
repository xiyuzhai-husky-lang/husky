...
use ecow::eco_format;
use husky_tex::diag::{FileError, FileResult, StrResult};
...
pub struct SystemWorld {
    ...
    /// The export cache, used for caching output files in `tex watch`
    /// sessions.
...
impl<T: Clone> SlotCell<T> {
    ...
    fn get_or_init(
        ...
        let fingerprint = timed!("hashing file", husky_tex::util::hash128(&result));
