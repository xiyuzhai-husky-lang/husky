...
pub struct TokenGroupBase(TokenIdx);
...
impl TokenGroupRelativeTokenIndex {
    pub(crate) fn new(base: TokenGroupBase, token_idx: TokenIdx) -> Self {
    ...
    pub(crate) fn token_idx(self, base: TokenGroupBase) -> TokenIdx {
        base.0 + self.0
    }
}
