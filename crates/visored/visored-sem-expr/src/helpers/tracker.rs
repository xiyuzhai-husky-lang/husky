...
//     expr::VdSynExprArena,
//     helpers::tracker::{IsVdSynInput, VdSynTracker},
...
// pub struct VdSemExprTracker<'a, Input: IsVdSemInput<'a>> {
//     pub input: Input,
...
//     pub result: Input::VdSemExprOutput,
// }

// pub trait IsVdSemInput<'a>: IsVdSynInput<'a> {
//     type VdSemExprOutput: IsVdSemOutput;
// }

// pub trait IsVdSemOutput: std::fmt::Debug + Copy {}

// impl<'a, Input: IsVdSemInput<'a>> VdSemExprTracker<'a, Input> {
//     pub fn new(
//         input: Input,
//         root_mode: LxMode,
...
//             output: syn_output,
//         } = VdSynTracker::new(input, token_annotations, space_annotations, db);
...
//         );
//         let result = syn_output.to_vd_sem(&mut builder);
//         let (
//             expr_arena,
//             phrase_arena,
//             clause_arena,
