...
pub struct VdSemExprExample {
    ...
    pub syn_expr_arena: VdSynExprArena,
    pub syn_phrase_arena: VdSynPhraseArena,
    pub syn_clause_arena: VdSynClauseArena,
    pub syn_sentence_arena: VdSynSentenceArena,
    pub syn_stmt_arena: VdSynStmtArena,
    pub syn_division_arena: VdSynDivisionArena,
    pub syn_expr_range_map: VdSynExprTokenIdxRangeMap,
    pub syn_phrase_range_map: VdSynPhraseTokenIdxRangeMap,
    pub syn_clause_range_map: VdSynClauseTokenIdxRangeMap,
    pub syn_sentence_range_map: VdSynSentenceTokenIdxRangeMap,
    pub syn_stmt_range_map: VdSynStmtTokenIdxRangeMap,
    pub syn_division_range_map: VdSynDivisionTokenIdxRangeMap,
...
impl VdSemExprExample {
    pub fn new(
        ...
        Self {
            ...
            syn_division_arena,
            syn_expr_range_map,
            syn_phrase_range_map,
            syn_clause_range_map,
            syn_sentence_range_map,
            syn_stmt_range_map,
            syn_division_range_map,
            expr_arena,
            phrase_arena,
            clause_arena,
            sentence_arena,
