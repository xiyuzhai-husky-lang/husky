...
impl VdFuncKeyDictionary {
    pub fn new_standard(db: &::salsa::Db) -> Self {
        ...
        Self::new([
            ...
            (nat_ne, BinaryOprAsSeparator(ln_nat_ne)),
            (int_ne, BinaryOprAsSeparator(ln_int_ne)),
            (rat_ne, BinaryOprAsSeparator(ln_rat_ne)),
            (real_ne, BinaryOprAsSeparator(ln_real_ne)),
            (nat_lt, BinaryOprAsSeparator(ln_nat_lt)),
            (int_lt, BinaryOprAsSeparator(ln_int_lt)),
            (rat_lt, BinaryOprAsSeparator(ln_rat_lt)),
            (real_lt, BinaryOprAsSeparator(ln_real_lt)),
            (nat_gt, BinaryOprAsSeparator(ln_nat_gt)),
            (int_gt, BinaryOprAsSeparator(ln_int_gt)),
            (rat_gt, BinaryOprAsSeparator(ln_rat_gt)),
            (real_gt, BinaryOprAsSeparator(ln_real_gt)),
