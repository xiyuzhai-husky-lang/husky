...
def h(a : ℝ)(b : ℝ)(c : ℝ) := by
  have h1 : (a - b) ^ 2 + (b - c) ^ 2 + (c - a) ^ 2 ≥ 0 := by calc
      (a - b) ^ 2 + (b - c) ^ 2 + (c - a) ^ 2 = a ^ 2 - 2 * a * b + b ^ 2 + (b ^ 2 - 2 * b * c + c ^ 2) + (c ^ 2 - 2 * c * a + a ^ 2) := obvious
    _ = 2 * (a ^ 2) + 2 * (b ^ 2) + 2 * (c ^ 2) - 2 * a * b - 2 * b * c - 2 * c * a := obvious
    _ ≥ 0 := obvious
...
def h(x : ℝ)(h1 : x > 0) := by
  ...
  have h5 : (x ^ 2 - 2 * x + 1) / x ≥ 0 := by calc
      (x ^ 2 - 2 * x + 1) / x = x ^ 2 / x - 2 * x / x + 1 / x := obvious
    _ = x - 2 + 1 / x := obvious
    _ ≥ 0 := obvious
...
def h(a : ℝ)(b : ℝ) := by
  have h1 : (a ^ 2 + b ^ 2) / 2 - ((a + b) / 2) ^ 2 ≥ 0 := by calc
      (a ^ 2 + b ^ 2) / 2 - ((a + b) / 2) ^ 2 = (2 * (a ^ 2) + 2 * (b ^ 2)) / 4 - (a ^ 2 + 2 * a * b + b ^ 2) / 4 := obvious
    _ = (2 * (a ^ 2) + 2 * (b ^ 2) - (a ^ 2 + 2 * a * b + b ^ 2)) / 4 := obvious
    _ = (a ^ 2 - 2 * a * b + b ^ 2) / 4 := obvious
    _ = (a - b) ^ 2 / 4 := obvious
    _ ≥ 0 := obvious
