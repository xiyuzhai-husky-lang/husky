...
impl VdBaseSeparatorSignature {
    pub fn new(instantiation: VdInstantiation, item_ty: VdType, expr_ty: VdType) -> Self {
        ...
        let opr = match path {
            ...
            VdTraitItemPath::NatAdd => VdMirBaseSeparator::RING_ADD,
            VdTraitItemPath::NatMul => VdMirBaseSeparator::RING_MUL,
            VdTraitItemPath::RingAdd => VdMirBaseSeparator::RING_ADD,
            VdTraitItemPath::RingSub => todo!(),
            VdTraitItemPath::RingMul => VdMirBaseSeparator::RING_MUL,
