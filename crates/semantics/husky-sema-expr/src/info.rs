...
pub struct ExprTypeInfo {
    disambiguation_and_ty_result: (SemaExprResult<SemaExprData>, SemaExprResult<FluffyTerm>),
    expectation_rule_idx: Option<FluffyTermExpectationIdx>,
}

impl ExprTypeInfo {
    pub(crate) fn new(
        ty_result: (SemaExprResult<SemaExprData>, SemaExprResult<FluffyTerm>),
        expectation_rule_idx: Option<FluffyTermExpectationIdx>,
    ) -> Self {
        Self {
    ...
    pub fn disambiguation(&self) -> SemaExprResultRef<&SemaExprData> {
