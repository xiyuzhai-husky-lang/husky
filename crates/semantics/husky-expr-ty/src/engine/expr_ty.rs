...
impl<'a> ExprTypeEngine<'a> {
    ...
    fn calc_expr_ty(
        ...
        match self.expr_region_data[expr_idx] {
            SynExprData::Literal(literal_token_idx, _) => Ok((
            ...
            SynExprData::Err(_) => Err(DerivedExprTypeError::ExprError.into()),
        }
    }
