                    ...
                    (
                        ...
                        Ok(
                            FluffyTerm {
                                place: None,
                                base: FluffyTermBase::Ethereal(
                                    EtherealTerm(`fn(move  Array 30 r32) -> BinaryImage28`),
                                ),
                            },
                        ),
                    ),
                    ...
                    (
                        ...
                        Ok(
                            FluffyTerm {
                                place: None,
                                base: FluffyTermBase::Ethereal(
                                    EtherealTerm(`fn( Leash ConnectedComponent) -> List RawContour`),
                                ),
                            },
                        ),
                    ),
                    ...
                    (
                        ...
                        Ok(
                            FluffyTerm {
                                place: None,
                                base: FluffyTermBase::Ethereal(
                                    EtherealTerm(`fn(move  List Option Leash RawContour) -> EffHoles`),
                                ),
                            },
                        ),
                    ),
