                                ...
                                EtherealTermRitchie {
                                    ...
                                    parameter_contracted_tys: [
                                        EtherealTermRitchieParameter::Regular(
                                            EtherealTermRitchieRegularParameter {
                                                contract: Move,
                                                ty: EtherealTerm(`Array 31 r32`),
                                            },
                                        ),
                                    ],
                                    return_ty: EtherealTerm(`BinaryGrid28`),
                                },
                            ),
                        ),
                    ),
