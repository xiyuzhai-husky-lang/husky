...
impl std::ops::Index<SynPrincipalEntityPathSynExprIdx> for SemaExprRangeRegionData {
...
impl<'a> std::ops::Index<SynPrincipalEntityPathSynExprIdx> for SemaExprRangeCalculator<'a> {
    type Output = RegionalTokenIdxRange;
