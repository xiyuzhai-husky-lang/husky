...
pub struct TextElem {
    ...
    #[fold]
    #[default(TextSize(TypstAbsLength::pt(11.0).into()))]
    #[resolve]
    #[ghost]
    pub size: TextSize,
...
impl PlainText for TypstContentRefined<TextElem> {
...
pub(crate) fn variant(styles: TypstStyleChain) -> FontVariant {
    ...
    if TextElem::emph_in(styles).0 {
        variant.style = match variant.style {
            TypstFontStyle::Normal => TypstFontStyle::Italic,
            TypstFontStyle::Italic => TypstFontStyle::Normal,
            TypstFontStyle::Oblique => TypstFontStyle::Normal,
        }
    }
