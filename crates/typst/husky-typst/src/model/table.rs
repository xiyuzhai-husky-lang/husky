...
pub struct TableElem {
    ...
    #[variadic]
    pub children: Vec<TypstContentRefined<TableCell>>,
}
...
impl LayoutMultiple for TypstContentRefined<TableElem> {
    #[husky_typst_macros::time(name = "table", span = self.span())]
    fn layout(
        &self,
...
impl LocalName for TypstContentRefined<TableElem> {
...
impl Figurable for TypstContentRefined<TableElem> {}
...
impl Default for TypstContentRefined<TableCell> {
    fn default() -> Self {
        TypstContentRefined::new(TableCell::new(TypstContent::default()))
    }
}

impl ResolvableCell for TypstContentRefined<TableCell> {
    fn resolve_cell(
        mut self,
        x: usize,
        y: usize,
