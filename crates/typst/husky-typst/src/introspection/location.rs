...
impl Location {
    ...
    #[func]
    pub fn page(self, engine: &mut TypstEngine) -> NonZeroUsize {
    ...
    #[func]
    pub fn position(self, engine: &mut TypstEngine) -> TypstDict {
    ...
    /// returns `none`.
    #[func]
    pub fn page_numbering(self, engine: &mut TypstEngine) -> Option<Numbering> {
