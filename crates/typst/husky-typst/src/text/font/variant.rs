...
impl FontVariant {
    ...
    pub fn new(style: TypstFontStyle, weight: FontWeight, stretch: FontStretch) -> Self {
        Self {
            style,
            weight,
            stretch,
...
impl Default for TypstFontStyle {
    fn default() -> Self {
        Self::Normal
    }
}

impl From<usvg::FontStyle> for TypstFontStyle {
