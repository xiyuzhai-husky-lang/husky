...
use super::{FontStretch, FontWeight, TypstFontStyle};

#[derive(Debug, Default, Deserialize)]
pub struct Exception {
    pub family: Option<&'static str>,
    pub style: Option<TypstFontStyle>,
...
impl Exception {
    ...
    const fn style(self, style: TypstFontStyle) -> Self {
        Self {
            style: Some(style),
            ..self
        }
