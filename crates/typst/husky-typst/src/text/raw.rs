...
pub struct RawElem {
    ...
    #[synthesized]
    pub lines: Vec<TypstContentRefined<RawLine>>,
}
    ...
    fn highlight(&self, styles: TypstStyleChain) -> Vec<TypstContentRefined<RawLine>> {
        ...
        if matches!(lang.as_deref(), Some("typ" | "typst" | "typc")) {
            ...
            ThemedHighlighter::new(
                ...
                &mut |i, range, line| {
                    seq.push(
                        TypstContentRefined::new(RawLine::new(
                            i + 1,
                            count,
...
impl LocalName for TypstContentRefined<RawElem> {
...
impl Figurable for TypstContentRefined<RawElem> {}

impl PlainText for TypstContentRefined<RawElem> {
...
impl PlainText for TypstContentRefined<RawLine> {
    fn plain_text(&self, text: &mut EcoString) {
        text.push_str(self.text());
    }
}
...
fn to_tex(synt::Color { r, g, b, a }: synt::Color) -> TypstColor {
...
#[comemo::memoize]
#[husky_typst_macros::time(name = "load syntaxes")]
...
#[comemo::memoize]
#[husky_typst_macros::time(name = "load theme")]
