...
#[category]
pub static FOUNDATIONS: TypstDefnKind;

/// Hook up all `foundations` definitions.
pub(super) fn define(global: &mut TypstValueAssignmentGroup, inputs: TypstDict) {
