...
#[doc(inline)]
pub use husky_typst_macros::elem;
...
impl ElementSchemaRef {
    ...
    pub fn scope(&self) -> &'static TypstValueAssignmentGroup {
        &(self.0).0.scope
    }
...
/// to a vtable of `TypstContentRefined<Self>` w.r.t to the trait `C` where `capability` is
/// `TypeId::of::<dyn C>()`.
...
pub struct ElementSchema {
    ...
    pub scope: Lazy<TypstValueAssignmentGroup>,
