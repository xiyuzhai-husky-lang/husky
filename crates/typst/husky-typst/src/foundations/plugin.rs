...
///
/// - `(import "tex_env" "wasm_minimal_protocol_write_args_to_buffer" (func (param i32)))`
///
...
///
/// - `(import "tex_env" "wasm_minimal_protocol_send_result_to_host" (func (param i32 i32)))`
///
...
impl Plugin {
    ...
    #[comemo::memoize]
    #[husky_typst_macros::time(name = "load plugin")]
    ...
    #[comemo::memoize]
    #[husky_typst_macros::time(name = "call plugin")]
