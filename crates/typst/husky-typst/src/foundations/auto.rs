...
pub struct AutoTypstValue;

impl IntoTypstValue for AutoTypstValue {
    fn into_value(self) -> TypstValue {
        TypstValue::Auto
    }
}

impl FromTypstValue for AutoTypstValue {
...
impl Reflect for AutoTypstValue {
    fn input() -> CastInfo {
...
impl<T: Reflect> Reflect for Smart<T> {
    fn input() -> CastInfo {
        T::input() + AutoTypstValue::input()
    }

    fn output() -> CastInfo {
        T::output() + AutoTypstValue::output()
    }

    fn castable(value: &TypstValue) -> bool {
        AutoTypstValue::castable(value) || T::castable(value)
    }
}
