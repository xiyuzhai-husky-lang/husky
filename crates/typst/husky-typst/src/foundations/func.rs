...
#[doc(inline)]
pub use husky_typst_macros::func;
...
impl Func {
    ...
    pub fn scope(&self) -> Option<&'static TypstValueAssignmentGroup> {
        match &self.repr {
...
pub struct Closure {
    ...
    pub node: TypstSyntaxNode,
    /// Default values of named parameters.
    pub defaults: Vec<TypstValue>,
    /// Captured values from outer scopes.
    pub captured: TypstValueAssignmentGroup,
}
