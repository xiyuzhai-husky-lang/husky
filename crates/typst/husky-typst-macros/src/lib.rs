...
///
/// This implements `IsTypstElem` for the given type.
///
/// ```
/// /// A section heading.
/// #[elem(Show, Count)]
...
///
/// When tracing is enabled in the husky-typst-cli, this macro will record the
/// invokations of the function and store them in a global map. The map can be
/// accessed through the `tex_trace::RECORDER` static.
///
