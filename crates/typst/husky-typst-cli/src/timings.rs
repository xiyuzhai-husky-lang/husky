...
use husky_typst::syntax::TypstSynSpan;
...
impl Timer {
    ...
    pub fn record<T>(
        ...
        husky_typst_timing::export_json(writer, |span| {
...
fn resolve_span(world: &SystemWorld, span: TypstSynSpan) -> Option<(String, u32)> {
    let id = span.id()?;
