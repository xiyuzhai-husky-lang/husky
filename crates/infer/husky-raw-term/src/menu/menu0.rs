...
impl RawTermMenu0 {
    pub fn new(db: &dyn RawTermDb, toolchain: Toolchain) -> Self {
        ...
        RawTermMenu0 {
            ...
            option_ty_path: RawTermEntityPath::TypeOntology(entity_path_menu.option_ty_path())
                .into(),
            slice_ty_path: RawTermEntityPath::TypeOntology(entity_path_menu.slice_ty_path()).into(),
            str_ty_path: RawTermEntityPath::TypeOntology(entity_path_menu.str_ty_path()).into(),
            ref_ty_path: RawTermEntityPath::TypeOntology(entity_path_menu.ref_ty_path()).into(),
            list_ty: RawTermEntityPath::TypeOntology(entity_path_menu.list_ty_path()).into(),
            unit: RawTermEntityPath::TypeOntology(entity_path_menu.unit()).into(),
            never: RawTermEntityPath::TypeOntology(entity_path_menu.never()).into(),
            bool: RawTermEntityPath::TypeOntology(entity_path_menu.bool_ty_path()).into(),
            trai_ty: RawTermEntityPath::TypeOntology(entity_path_menu.trai_ty_path()).into(),
            lifetime_ty: RawTermEntityPath::TypeOntology(entity_path_menu.lifetime_ty_path())
                .into(),
            module: RawTermEntityPath::TypeOntology(entity_path_menu.module_ty_path()).into(),
            i8: RawTermEntityPath::TypeOntology(entity_path_menu.i8_ty_path()).into(),
            i16: RawTermEntityPath::TypeOntology(entity_path_menu.i16_ty_path()).into(),
            i32: RawTermEntityPath::TypeOntology(entity_path_menu.i32_ty_path()).into(),
            i64: RawTermEntityPath::TypeOntology(entity_path_menu.i64_ty_path()).into(),
            f32: RawTermEntityPath::TypeOntology(entity_path_menu.f32_ty_path()).into(),
            f64: RawTermEntityPath::TypeOntology(entity_path_menu.f64_ty_path()).into(),
            r32: RawTermEntityPath::TypeOntology(entity_path_menu.r32_ty_path()).into(),
            r64: RawTermEntityPath::TypeOntology(entity_path_menu.r64_ty_path()).into(),
        }
    }
