...
pub fn structure_ty_raw_signature(
    db: &dyn RawSignatureDb,
    decl: StructureTypeDecl,
) -> RawSignatureResult<StructureTypeRawSignature> {
    ...
    Ok(StructureTypeRawSignature::new(db, implicit_parameters))
}

#[salsa::tracked(db = RawSignatureDb, jar = RawSignatureJar)]
pub struct StructureTypeRawSignature {
    #[return_ref]
    pub implicit_parameters: ImplicitParameterRawSignatures,
}

impl StructureTypeRawSignature {}
