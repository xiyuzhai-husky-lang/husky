...
pub fn inductive_ty_raw_signature(
    db: &dyn RawSignatureDb,
    decl: InductiveTypeDecl,
) -> RawSignatureResult<InductiveTypeRawSignature> {
    ...
    Ok(InductiveTypeRawSignature::new(db, implicit_parameters))
}

#[salsa::interned(db = RawSignatureDb, jar = RawSignatureJar)]
pub struct InductiveTypeRawSignature {
    #[return_ref]
    pub implicit_parameters: ImplicitParameterRawSignatures,
}

impl InductiveTypeRawSignature {}
