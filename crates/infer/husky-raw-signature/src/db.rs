...
pub trait RawSignatureDb: salsa::DbWithJar<RawSignatureJar> + DeclDb + TermDb {
    fn raw_signature_term_region(&self, expr_region: ExprRegion) -> &RawSignatureTermRegion;
...
where
    Db: salsa::DbWithJar<RawSignatureJar> + DeclDb + TermDb,
{
    fn raw_signature_term_region(&self, expr_region: ExprRegion) -> &RawSignatureTermRegion {
