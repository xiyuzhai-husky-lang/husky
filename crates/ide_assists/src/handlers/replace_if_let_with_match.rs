...
fn pick_pattern_and_expr_order(
    sema: &semantics::Semantics<RootDatabase>,
    pat: ast::Pat,
    pat2: ast::Pat,
    expr: ast::Expr,
    expr2: ast::Expr,
...
fn binds_name(sema: &semantics::Semantics<RootDatabase>, pat: &ast::Pat) -> bool {
...
fn is_sad_pat(sema: &semantics::Semantics<RootDatabase>, pat: &ast::Pat) -> bool {
