...
pub fn major_connected_component() {
    let mut i0 = 0;
...
pub fn ignored_connected_components_row_span_sum_sum() {
    let mut sum = 0;
    for i in 0..connected_components.ilen() {
