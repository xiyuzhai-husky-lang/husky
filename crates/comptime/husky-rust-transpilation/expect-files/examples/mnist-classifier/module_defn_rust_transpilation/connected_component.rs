...
impl {
    ...
    fn upper_mass(self) {
        Self.distribution.upper_massas f32;
    }

    fn lower_mass(self) {
        Self.distribution.lower_massas f32;
    }
    ...
    fn top_k_row_span_sum(, ) {
        ...
        } return( top_k_row_span_sumas f32)
    }
