...
#[rustfmt::skip]
#[ad_hoc_devsoul_dependency::val_item(ingredient_index = 28, return_ref)]
pub fn six_match() -> crate::fermi::FermiMatchResult {
    crate::fermi::fermi_match(major_concave_components(), &vec![upmost])
}

#[rustfmt::skip]
#[ad_hoc_devsoul_dependency::val_item(ingredient_index = 29, return_ref)]
...
#[rustfmt::skip]
#[ad_hoc_devsoul_dependency::val_item(ingredient_index = 30, lazy)]
