...
fn is_two { require!( matches!) require!( matches!) require!( matches!) require!( matches!) require!( matches!) require!( matches!)
    ...
    let lower_excess = major_connected_component.lower_mass- major_connected_component.upper_mass; require!( lower_excess>10)
    if cc_num==2 { require!( matches!) require!( matches!)
