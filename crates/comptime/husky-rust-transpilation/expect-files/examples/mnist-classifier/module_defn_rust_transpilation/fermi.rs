...
impl crate::fermi::FermiMatchResult {
    #[ad_hoc_task_dependency::memo_field(ingredient_index = 21)]
    ...
    #[ad_hoc_task_dependency::memo_field(ingredient_index = 22)]
    ...
    #[ad_hoc_task_dependency::memo_field(ingredient_index = 23)]
