...
use crate::{CycleError, Database, QueryDb, RevisionId, SalsaQueryKeyIndex};
...
impl<Q, MP> QueryStorageTrait<Q> for DerivedStorage<Q, MP>
where
    Q: QueryFunction,
    MP: MemoizationPolicy<Q>,
{
...
impl<Q, MP> WholeQueryStorageTrait for DerivedStorage<Q, MP>
where
    Q: QueryFunction,
    MP: MemoizationPolicy<Q>,
{
