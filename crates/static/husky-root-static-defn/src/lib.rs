...
pub fn __resolve_root_defn(ident: RootBuiltinIdentifier) -> &'static EntityStaticDefn {
    match ident {
        ...
        RootBuiltinIdentifier::TraitType => &TRAIT_TYPE_DEFN,
        ...
        RootBuiltinIdentifier::ModuleType => &MODULE_TYPE_DEFN,
