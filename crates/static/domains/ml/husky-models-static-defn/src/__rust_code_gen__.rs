...
#[rustfmt::skip]
#[no_mangle]
pub unsafe extern "C" fn __svm_with_vmax_normalized_internal_clone(data: *mut std::ffi::c_void) -> *mut std::ffi::c_void {
    Box::<SvmWithVmaxNormalizedInternal>::into_raw(Box::new((*(data as *mut SvmWithVmaxNormalizedInternal)).clone())) as *mut std::ffi::c_void
}
#[rustfmt::skip]
#[no_mangle]
pub unsafe extern "C" fn __svm_with_vmax_normalized_internal_drop(data: *mut std::ffi::c_void) {
    drop(Box::from_raw(data as *mut SvmWithVmaxNormalizedInternal))
}
#[rustfmt::skip]
#[no_mangle]
pub unsafe extern "C" fn __svm_with_vmax_normalized_internal_eq(this: &std::ffi::c_void, other: &std::ffi::c_void) -> bool {
    *(this as *const std::ffi::c_void as *const SvmWithVmaxNormalizedInternal) == *(other as *const std::ffi::c_void as *const SvmWithVmaxNormalizedInternal)
}
#[rustfmt::skip]
#[no_mangle]
pub unsafe extern "C" fn __svm_with_vmax_normalized_internal_assign(registers: *mut __Register) {
    let registers = std::slice::from_raw_parts_mut(registers, 2);
    *registers[0].downcast_temp_mut::<SvmWithVmaxNormalizedInternal>(&__SVM_WITH_VMAX_NORMALIZED_INTERNAL_VTABLE) = registers[1].downcast_move(&__SVM_WITH_VMAX_NORMALIZED_INTERNAL_VTABLE)
}
#[rustfmt::skip]
#[no_mangle]
pub static __SVM_WITH_VMAX_NORMALIZED_INTERNAL_VTABLE: __RegisterTyVTable = __RegisterTyVTable {
    primitive_value_to_bool: None,
    primitive_ref_to_bool: None,
    primitive_value_to_box: None,
    clone: __svm_with_vmax_normalized_internal_clone,
    drop: __svm_with_vmax_normalized_internal_drop,
    eq: __svm_with_vmax_normalized_internal_eq,
    assign: __svm_with_vmax_normalized_internal_assign,
    typename_str_hash_u64: 15989892890880664358,
    typename_str: "SvmWithVmaxNormalizedInternal",
};
