...
pub unsafe extern "C" fn __naive_i_32_internal_clone(data: *mut ()) -> *mut () {
    Box::<NaiveI32Internal>::into_raw(Box::new((*(data as *mut NaiveI32Internal)).clone()))
        as *mut ()
}
#[no_mangle]
...
pub unsafe extern "C" fn __naive_i_32_internal_eq(this: &(), other: &()) -> bool {
    *(this as *const () as *const NaiveI32Internal)
        == *(other as *const () as *const NaiveI32Internal)
}
#[no_mangle]
pub unsafe extern "C" fn __naive_i_32_internal_assign(registers: *mut __Register) {
    ...
    *registers[0].downcast_temp_mut::<NaiveI32Internal>(&__NAIVE_I_32_INTERNAL_VTABLE) =
        registers[1].downcast_move(&__NAIVE_I_32_INTERNAL_VTABLE)
}
#[no_mangle]
