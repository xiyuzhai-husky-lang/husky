...
use crate::config::{huskyfmt::HuskyfmtConfig, ServerConfig};
...
pub fn server_capabilities(config: &ServerConfig) -> ServerCapabilities {
    ServerCapabilities {
        ...
        completion_provider: Some(CompletionOptions {
            resolve_provider: completions_resolve_provider(&config.client_capabilities),
        ...
        code_action_provider: Some(code_action_capabilities(&config.client_capabilities)),
        code_lens_provider: Some(CodeLensOptions {
            resolve_provider: Some(true),
        }),
        document_formatting_provider: Some(OneOf::Left(true)),
        document_range_formatting_provider: match config.fmt() {
            HuskyfmtConfig::Huskyfmt {
