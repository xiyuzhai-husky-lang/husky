...
diagnostics_misc_dir = os.path.join(husky_dir, "test-examples/analyzer/diagnostics/misc")
...
save_dir = "./test-examples/analyzer/diagnostics/misc/mnist-classifier{:03d}".format(new_idx)
