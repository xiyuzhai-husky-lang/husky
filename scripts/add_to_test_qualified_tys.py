...
qualified_tys_misc_dir = os.path.join(
    husky_dir, "test-examples/analyzer/qualified-tys/misc"
)
...
save_dir = "./test-examples/analyzer/qualified-tys/misc/mnist-classifier{:03d}".format(
    new_idx
)
