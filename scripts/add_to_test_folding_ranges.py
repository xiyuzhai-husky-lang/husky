...
folding_ranges_misc_dir = os.path.join(husky_dir, "test-examples/analyzer/folding-ranges/misc")
...
save_dir = "./test-examples/analyzer/folding-ranges/misc/mnist-classifier{:03d}".format(new_idx)
