<script lang="ts">
    ...
    import type FigureControlProps from "src/figsrc/figure/FigureControlPropsimport type FigureProps from "srcsrc/figure/FigureProps    import FigureCanvas from "./Figure/Canvas.svelte";
