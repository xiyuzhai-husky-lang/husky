...
#[rustfmt::skip]
#[no_mangle]
pub unsafe extern "C" fn __b_clone(data: *mut std::ffi::c_void) -> *mut std::ffi::c_void {
    Box::<B>::into_raw(Box::new((*(data as *mut B)).clone())) as *mut std::ffi::c_void
}
#[rustfmt::skip]
#[no_mangle]
pub unsafe extern "C" fn __b_drop(data: *mut std::ffi::c_void) {
    drop(Box::from_raw(data as *mut B))
}
#[rustfmt::skip]
#[no_mangle]
pub unsafe extern "C" fn __b_eq(this: &std::ffi::c_void, other: &std::ffi::c_void) -> bool {
    *(this as *const std::ffi::c_void as *const B) == *(other as *const std::ffi::c_void as *const B)
}
#[rustfmt::skip]
#[no_mangle]
