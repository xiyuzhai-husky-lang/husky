...
use arithmetic_examples::__init__::link_entity_with_compiled;
use compile_time_db::*;
...
fn init_compile_time(compile_time: &mut HuskyLangCompileTime) {
    compile_time.load_package("/home/xiyuzhai/Documents/husky/rust-gen/arithmetic-examples/snapshot".into());
